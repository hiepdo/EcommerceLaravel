                                    ...
                                    @csrf
                                        ...
                                        <a id="wishlist_deleteurl{{$product->product_id}}" href="{{ URL::full()}}" class="product-name"><span></span></a>
                                           <?php  $like = 0; ?>
											...
											<button type="button" data-id_product="{{$product->product_id}}" class="btn btn-danger my-btn--liked delete-to-wishlist-ajax" name="add_to_wishlist" ><i class="fa fa-heart" aria-hidden="true"></i></button>
											<?php }else{?>
												<button type="button"  class="btn btn-danger my-btn" id="{{$product->product_id}}" onclick="add_wishlist(this.id);" ><i class="fa fa-heart" aria-hidden="true"></i></button>
											<?php } ?>
