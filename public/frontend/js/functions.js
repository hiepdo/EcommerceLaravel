            ...
            mercado_price_quantity: function() {
                if ($(".quantity-input").length > 0) {
                    $(".quantity-input").on('click', '.btn', function(event) {
                        event.preventDefault();
                        var _this = $(this),
                            _input = _this.siblings('input[name=product_quatity]'),
                            _current_value = _this.siblings('input[name=product_quatity]').val(),
                            _max_value = _this.siblings('input[name=product_quatity]').attr('data-max');
